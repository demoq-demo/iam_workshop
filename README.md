...
| **❌ POLICY THAT FAILS** | **🔍 API METHOD** | **✅ POLICY THAT PASSES** |
|--------------------------|-------------------|---------------------------|
| **New Policy (Expanded Permissions)** | `check-no-new-access` | **New Policy (Same/Reduced Permissions)** |
| ```json
{
  "Version": "2012-10-17",
  "Statement": [
...
``` | Compares new policy against reference policy to detect permission expansion | ```json
{
  "Version": "2012-10-17",
  "Statement": [
    {
...
``` |
| **Reference Policy** | | **Reference Policy (Same)** |
| ```json
{
  "Version": "2012-10-17",
  "Statement": [
